...
class UAVPreparer:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&UAVPreparer')
    ...
    def run(self):
        ...
        # Access the vector layer and the field
    ...
    def help(self):
        url = 'https://github.com/hwlai/UAVPreparer'
    ...
    def start_progress(self):
        ...
        if idx == -1:
            QMessageBox.critical(None, 'Error', 'An attribute with numbers has to e selected')
            return
